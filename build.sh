...
echo "###########################################################################################################"
echo ""
get_required_kitsune_lib_repo "libKitsunemimiJson" "v0.11.1" 1 "staticlib"
echo ""
echo "###########################################################################################################"
echo ""
get_required_kitsune_lib_repo "libKitsunemimiJinja2" "v0.9.0" 1 "staticlib"
echo ""
echo "###########################################################################################################"
echo ""
...
if [ $1 = "test" ]; then
    build_kitsune_lib_repo "libKitsunemimiSakuraLang" 1 "staticlib run_tests"
else
    build_kitsune_lib_repo "libKitsunemimiSakuraLang" 1 "staticlib"
fi
